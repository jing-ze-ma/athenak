...
run H1c "$BASE_H hydro/rad_tau_lo=20   hydro/rad_tau_hi=300"
run H2c "$BASE_H hydro/rad_tau_lo=5    hydro/rad_tau_hi=50"
run H3c "$BASE_H hydro/rad_tau_lo=50   hydro/rad_tau_hi=1000"
echo "##### ALL DONE"
