#!/bin/bash -l
#SBATCH -o /viper/u2/jinma/ATHENAK/bench/wt_he4/tests_3d/relax1d_fix.log
#SBATCH -e /viper/u2/jinma/ATHENAK/bench/wt_he4/tests_3d/relax1d_fix.err
#SBATCH -J he4_r1d
#SBATCH -p apudev
#SBATCH --nodes=1
#SBATCH --ntasks=2
...
mkdir -p $B/tests_3d/relax1d_fix && cd $B/tests_3d/relax1d_fix
