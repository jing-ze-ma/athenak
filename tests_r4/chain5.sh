...
# ARM, WALL, TLIM, VPERT come in through --export
module purge
...
OV="problem/inner_bc=wall problem/rt_bottom_flux=true hydro/rad_flux_inner=1.305278e15
 problem/mlt_alpha=0.0 problem/vpert=$VPERT"
COMMON="time/tlim=$TLIM output1/dt=47.0 output2/dt=2352.5 output3/dt=1.0e30
