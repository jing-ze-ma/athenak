...
# tests_r23: 1-D discriminator for the standing inflow at the IC density cliff
# (physical i ~ 99/100, r/R ~ 1.025) in the tall He4 column.  Same body as
# tests_r14/r14_long.sh, but the run directory is under tests_r23, and tlim /
...
d=$1; shift
A=$B/tests_r23/$d; rm -rf $A; mkdir -p $A; cd $A
