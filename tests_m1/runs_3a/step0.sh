#!/bin/bash -l
# MILESTONE 3a, STEP 0: the EXPLICIT scheme must be bitwise what it was.  Same runs as
# tests_m1/runs_1cB/step0.sh, judged against that milestone's RESULTS.txt.
R=/viper/u2/jinma/ATHENAK/bench/wt_m1impl
X=$R/build_cpu_m1/src/athena
O=$R/tests_m1/runs_3a/step0
rm -rf $O; mkdir -p $O
