...
# runs_3x_hesdirk2 G5: 3-D seeded He slab, eddington + plm + vimp + hesdirk2 (central), cfl 0.3, tlim 1000.
module purge
...
if [ -n "$LAST" ]; then
  ...
  srun -n 1 /viper/ptmp2/jinma/h2_3x/g5/athena_gpu -i ../he_slab_m1_3d_h2.athinput -d . -t 01:50:00 $OV > $LOG 2>&1
fi
echo "rc=$?"
