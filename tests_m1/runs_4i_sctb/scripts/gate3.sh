...
NEW=${NEW:-tb3}
md5sum ../bin/athena_ref_cpu ../bin/athena_${NEW}_cpu
...
go new_Fx2r4 $NEW Fx2r4 & wait
go new_Ux1r4 $NEW Ux1r4 & go new_Fx12r4 $NEW Fx12r4 & wait
go new_T3r4 $NEW T3r4 & wait
go new_Uoddr3 $NEW Uoddr3 & go new_U1 $NEW U1 & go new_T3r2 $NEW T3r2 & wait
go new_Ux2b2r2 $NEW Ux2b2r2 & go new_T3r1 $NEW T3r1 & go new_Ux2r1 $NEW Ux2r1 & wait
...
gt tb3nd_T3r4 T3r4 tb $TB3 rad_m1/vet_mb_tblock_direct=false & gt tb3nd_Fx12r4 Fx12r4 tbd $TB3 rad_m1/vet_mb_tblock_direct=false & gt tb3k_T3r2 T3r2 tb $TB3 rad_m1/vet_mb_tblock_tk=5 & wait
gt hy2t_T3r4 T3r4 tb rad_m1/vet_mb_agroup=2 $TB3 rad_m1/vet_mb_tblock_tj=5 & wait
