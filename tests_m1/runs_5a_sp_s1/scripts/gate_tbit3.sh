...
for t in slab1 slab2 slabnd2 vet2 vimp2 box4 boxd4 expl2 mkx1 mkcart spblast; do
  echo "== $t: $(python3 $W/cmp.py $W/cpu/t_${t}_ref2 $W/cpu/t_${t}_mrg | tail -n1) rc $(tail -n1 $W/cpu/t_${t}_ref2/log.txt) $(tail -n1 $W/cpu/t_${t}_mrg/log.txt)"
done
echo TBIT DONE
