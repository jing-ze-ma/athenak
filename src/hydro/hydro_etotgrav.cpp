...
namespace hydro {
//----------------------------------------------------------------------------------------
//! \fn void Hydro::AddGravFlux
//! \brief Implements the gravity term in the energy flux.

void Hydro::AddGravFlux(const DvceFaceFld4D<Real> &phi0, DvceFaceFld5D<Real> &flx) {
...
//----------------------------------------------------------------------------------------
//! \fn void Hydro::AddGravEtot
//! \brief Adds the gravitational potential energy in the total energy.

void Hydro::AddGravEtot(const DvceArray4D<Real> &phicc0, DvceArray5D<Real> &cons, const int il, const int iu, const int jl, const int ju, const int kl, const int ku) {
    int nmb1 = pmy_pack->nmb_thispack - 1;
...
//----------------------------------------------------------------------------------------
//! \fn void Hydro::RemoveGravEtot
//! \brief Removes the gravitational potential energy from the total energy.

void Hydro::RemoveGravEtot(const DvceArray4D<Real> &phicc0, DvceArray5D<Real> &cons, const int il, const int iu, const int jl, const int ju, const int kl, const int ku) {
    int nmb1 = pmy_pack->nmb_thispack - 1;
