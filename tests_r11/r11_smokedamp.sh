...
A=$B/tests_r11/smokedamp; rm -rf $A; mkdir -p $A; cd $A
...
srun -n 2 $B/tests_r11/athena_v19 -i $B/inputs/hydro/he4_presn_sp.athinput $OV \
  time/nlim=20 problem/vpert_var=eint problem/vpert=3.0e-2 problem/vpert_sp_rand=true problem/vdamp_all_mean_only=true problem/vdamp_all_until=18820.0 problem/vdamp_all_time=500.0 output2/dt=30.0 mesh/nx2=192 mesh/nx3=192 meshblock/nx2=24 meshblock/nx3=24 output1/dt=1e30 output2/dt=1e30 output3/dt=1e30 \
