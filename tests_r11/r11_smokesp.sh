...
A=$B/tests_r11/smokesp; rm -rf $A; mkdir -p $A; cd $A
...
srun -n 2 $B/tests_r11/athena_v16 -i $B/inputs/hydro/he4_presn_sp.athinput $OV \
  time/nlim=40 output1/dt=1e30 output2/dt=1e30 output3/dt=1e30 \
