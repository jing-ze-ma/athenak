...
run r0 $B/athena.base true  true
run r1 $B/athena.opt  true  false
run r2 $B/athena.opt  true  true
run r3 $B/athena.opt  false false
run r4 $B/athena.opt  false true
echo "---- summary ----"
