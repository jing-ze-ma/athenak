...
- **[DELEGATE to SONNET when adequate (user 09-22)](delegate-to-sonnet-when-adequate.md)** — mechanical/gated/read-only work -> sonnet; new schemes, diagnoses, ungated deletions -> opus
