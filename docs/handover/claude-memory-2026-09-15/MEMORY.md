...
- **[He 3-D BOX mode 3 STAGED 09-15 (box_m3, not submitted, binary e9664224 staged + smoked): measured 134 ms/cycle on 8 GPUs = 51 h / 3 links, 214 ms on 2 GPUs; transverse operator + halos = 37 % (244 swaps/cycle), scaling 40 %; IC mode-3 relaxed; lid mode = damped box acoustic fundamental 151 s; RESTARTED 09-15 ~03:15 on 76b42ca8 + rad_tr_halo_every=2 IN THE INPUT (H2e2 smoke bitwise = H2, 20 % faster on 2 GPUs) as chain 11710108 -> 11710109 -> 11710110 (submit_e2.sh); the 20-min e9664224 run is in box_m3/prev_run_e9664224_0915 (clean: E drift -6.6e-4 = 5 ppm mean flux imbalance, Ftop/Fbot 1.0013)](he-box-m3-staging.md)**
- **[NEXT (user 09-15): WARM-STARTED NEWTON for the mode-3 column after the chains are healthy; column solve >50 % of the cycle; parity with hydro unreachable](warm-started-newton-plan.md)**
...
- **[MULTI-D SHORT CHARACTERISTICS for the thin layers: scoped and PARKED by the user for a later discussion; ~1000 lines, plane-by-plane GPU sweep, ALI coupling](multid-short-characteristics-plan.md)**
