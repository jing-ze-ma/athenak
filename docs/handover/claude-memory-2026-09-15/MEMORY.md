...
- **[OVERNIGHT 09-15: user asleep; NO watches, NO reactions on the production chains; record agent results only](overnight-rules-0915.md)**
...
**CURRENT STATE, 2026-09-15 (~23:30), VIPER.** B-star MODE-3 PRODUCTION B-STAR PRODUCTION STOPPED 09-15 ~09:20 BY THE USER (do not restart the chain): 11711557-9 (operator everywhere, from rst 00012) cancelled right after submission; last healthy state = rst 00012 (t 1.2e5, 12 turnovers); the outputs up to t 1.293e5 exist (runaway rows after 1.26e5 superseded); submit.sh/input currently carry rad_tr_tau 0/0 (11711199-223 with taper 1/3 cancelled at t 1.293e5 during the top-row runaway; 11710002-4 with 3/10 cancelled at 1.101e5); hst/out.txt/rt_surface carry superseded rows for t 1.2e5-1.293e5 (dedupe keeping the LAST occurrence); binary e9664224 (all fixes, PCR nseg 32, 18.4 h projected for 40 turnovers = link 1) (afterany, restart-aware, link 1 clean), 4 nodes x 2 GPUs, 23:55 each, ~42 h wall for 40 turnovers (mode 3 = 2.30x mode 0; links 1+2 finish, 3 = margin); binary build_hip_final (wt_rgbox 303e08cd, md5 a13cfd16), column ic_fecz_rt_relaxed_m3whole_taper.txt, gated in bench/bstar_fecz/final_gate (G0 bitwise mode 0, G3: Ftop/Fbot 1.00004, v_rms 8.2e2, Newton 2-3 passes, M_max 0.158, rt_impl_tol 1e-8 maxit 8). prod_taper FINISHED (analysis/observables.*). PCR branch rg-box-pcr (bench/wt_m3acc, b56c30b1: rt_impl_solver partition + rt_impl_nseg) timings pending on apudev. He qual_m3: mode 3 shows a FLUX COLLAPSE on the He column, control arm without u-form running (hestar_fecz/qual_m3) - He production NOT ready. Handover: docs/handover/HANDOVER-2026-09-15.md (viper; memory snapshot claude-memory-2026-09-15). Details: [[bstar-column-pulsation]], [[rt-source-dt-forcing]], [[implicit-transverse-raddiff-plan]], [[port-rt-fixes-to-rg-dhj]].

**NEXT STEPS (09-15 late):** (1) watch prod_m3 link 1 (out.txt in prod_m3; FATAL grep; first turnover ~1 h); analysis templates in rt2turn_topcut/analysis and prod_taper/analysis; (2) PCR timing report -> if <= 1.2x standard, NOT for the running chain (bitwise change) - for He/rg/dhj; (3) He: diagnose the mode-3 flux collapse (u-form control) before any He box; (4) port mode 3 + outputs to rg/dhj/ck and rerun rg/dhj with new defaults + re-relaxed atmospheres; (5) sp_mhd_nopole links (user); (6) TO DISCUSS: PCG/multigrid horizontal operator, multi-D short characteristics; (7) merge order lhlld -> implicit-transverse-raddiff -> rg-box-convection (+ rg-box-pcr) onto polar-average-perf.


- **[He 3-D BOX mode 3 STAGED 09-15 (box_m3, not submitted, binary e9664224 staged + smoked): measured 134 ms/cycle on 8 GPUs = 51 h / 3 links, 214 ms on 2 GPUs; transverse operator + halos = 37 % (244 swaps/cycle), scaling 40 %; IC mode-3 relaxed; lid mode = damped box acoustic fundamental 151 s; DIED 09-15 ~04:30 at t = 4003.6 s (1.06 turnovers, cycle 41834): dt collapsed to 9e-9 (STOP file set, links 2-3 exited); dt fluctuating from t ~3800, Ttop rms 17 %, Ftop/Fbot 1.106, KE 1.7e30 (24x), E -8e-3; chain 11710108-110 (76b42ca8 + halo_every 2, 95 ms/cycle on 8 GPUs) - = lid evacuation by the trapped box mode at 17x v_MLT (physical trapping, acoustic cutoff); TOP SPONGE (vdamp_top_tau 0.3 / 20 s) only DELAYED the death to t 5495 (1.46 turnovers); death-site diagnosis running; He production OFF until solved; the 20-min e9664224 run is in box_m3/prev_run_e9664224_0915 (clean: E drift -6.6e-4 = 5 ppm mean flux imbalance, Ftop/Fbot 1.0013)](he-box-m3-staging.md)**
- **[B-star PHOTOSPHERE PLAID 09-15 (OPEN): stationary 10-cell diagonal wave trains above tau 3 (transverse RT off there), mode-3 only, from turnover 1; CURED in production: restart 11711199 at t 1.1e5 with rad_tr_tau 1/3; band power 0.78 -> 0.002 in 2e3 s, Ftop/Fbot 1.005; taper 1/3 -> TOP-ROW THERMAL RUNAWAY from t 1.26e5; RESTARTED from rst 00012 with the operator everywhere (0/0)](bstar-photosphere-checkerboard.md)**
- [B-star PRELIM SCIENCE PAGE 09-15 (8 turnovers): https://claude.ai/artifact/HQ5bHyDW67yShdAygahjBS - 0.87 mmag rms, Mach 0.15 at tau=2/3](bstar-prelim-science-page.md)
- **[ADI TRANSVERSE COMMITTED 91d895de (rg-box-pcr): lod2 = Richardson LOD, 2nd order, RKL1-accurate on the gate, 60 vs 71 ms/cyc (1 rank), 209 vs 222 (4 ranks), He 0.76x -> use for the He restart; B star stays RKL1](adi-transverse-operator.md)**
- **[HYBRID COLUMN 09-15 (wt_hyb, uncommitted): diffusion below tau_h=100 + two-stream above in ONE Newton system, EXACT to 1e-12, 1.28-1.46x on Thomas; needs the PCR port (after the reduced-solve lands) to beat production](hybrid-column-solve.md)**
- **[RT ACCELERATION INVENTORY 09-15: once REJECTED, margin 1 %, split incompatible, sweep skip +11 % (b6413928, off by default), residual check DONE bitwise -15 % Newton loop (57129d5c, DEFAULT ON since 3596f5b3), frozen Jacobian no gain, PCG 1.7-2.2x slower, nquad 1 rejected (-9.6 % flux); NEXT = parallel reduced-system solve (29 % of a PCR pass) + hybrid deep-diffusion column, both running](rt-acceleration-inventory-0915.md)**
- **[WARM-STARTED NEWTON TRIED 09-15: safe, bitwise off, NO GAIN (Newton at its 2-pass floor); frozen Jacobian stage 2 TRIED: correct, 3 % slower on the B star (+4.6 % He 1-D), uncommitted in wt_fj; column at its floor](warm-started-newton-plan.md)**
- **[RKL1 HALO EVERY-N SUBSTAGES 76b42ca8 (09-15): N=2 bitwise, operator -51 % (B star 259 -> 222 ms at 4 ranks); use hydro/rad_tr_halo_every=2 at the He link-2 break; slabs/edges are dead levers](rkl1-halo-every.md)**
- **[RKL1 HALO GPU-MPI RACE FIXED e9664224 (09-15): device recvbuf re-posted under the async unpack; 1 block/rank across nodes was WRONG on every binary; fence cures, 4 ranks bitwise with 2, 259 ms/cycle; candidate binary build_hip_prode9664224 md5 64154051 staged as prod_m3/athena_pinned_e9664224; p_prod8gpu PASSED (8 ranks x 4 nodes = 2-rank full-mesh ref: time/dt/user.hst bitwise, E 1e-16; 247 ms/cycle -> 18.4 h for 40 turnovers = ONE link); G3g PASSED (bitwise = G3e); prod_m3 SWITCHED to athena_pinned_e9664224 + PCR input (backup fecz_rt.athinput.pre_pcr_backup); chain 11709068-70 CANCELLED (ran the stale binary, sbatch snapshot); RESUBMITTED 11710002 -> 11710003 -> 11710004 with BIN=athena_pinned_e9664224 verified in the stored script; stale outputs in prod_m3/stale_run_oldbinary_0915; VERIFIED at start 09-15 ~02:10: solver pcr nseg 32, F_bot carried by the two-stream, 8 ranks, 242 ms/cycle (200 cycles in 48 s), dt 1.495; link 1 running on vipa[1051,1097,1108,1206]; FIRST TURNOVER CLEAN (t 1e4, cycle 6600 in 1763 s = 267 ms/cycle incl. dumps -> 19.8 h for 40 turnovers, fits link 1; E drift 7e-6, Ftop/Fbot 1.009, KE 2.7e32, no FATAL)](rkl1-halo-gpu-mpi-race.md)**
- **[RESTART WB-CACHE PHASE BUG 09-15: FIXED 7ca9c57f to roundoff (KE 5e-4 -> 3e-10; 1-ULP dt residual = non-idempotent EOS inversion at restart, deferred); pre-existing in the old prod binary; candidate binary build_hip_prod7ca9c57f md5 924480c8 GATED on 1 rank (G3e: = G3d until the first rst write at t=1000 as designed, then within scatter, Ftop 1.00000, 2.59e5 zc/s), staged as prod_m3/athena_pinned_7ca9c57f](restart-wb-cache-phase-bug.md)**
- **[rg/dhj AUDIT 09-15: B-star bug classes NOT live there; dhj double-internal-flux guard ADDED (fatal, commit on implicit-transverse-raddiff 09-15, unpushed); mode-3 port needs rg rt_bot_flux wiring + ck gate](rg-dhj-bottom-flux-audit.md)**
- **[B-STAR RE-GATE 09-16: PCR 2.07x on the gate box, tol 1e-6 REJECTED, PCR path fixed 1fdce2b0, He MATRIX REGENERATED (Q1p2/Q2p/Q3p/Q4p all Ftop 0.997-0.998, cfl-independent, Newton 3 passes; mode-3 He column READY, 3-D He box next); G3p2 PASSED (tracks G3f: v_rms 894 vs 882, Ftop 1.00000, 2.59e5 zone-cycles/s = 2.4x Thomas; P_nyq meaningless when dT_tau10 ~1e-7, checkerboard amp 1e-8 in all fixed arms); rt_col3_once REJECTED (4x v_rms floor, 6 % gain); bvals window a8c69bc9 1.12x prod, BITWISE (G3b = G3p data, 1.23x on the gate box); candidate prod binary = build_hip_bvfix (HEAD 995ab40b = 9ba8b080 + bvals same-level guard, md5 b5c936ae, final_gate/athena_pinned_995ab40b); gates G3c (prod9ba8 vs G3p2) and G3d (995ab40b vs G3c) must be data-bitwise; RESTART GATE NOT BITWISE on prod9ba8 (first post-restart cycle: dt 2.5e-10, E 1.9e-11, KE 5e-4 rel; time itself 2.8e-13 off; arms final_gate/R_straight,R_cont) - bisect across old final / botfix / thomas-on-new running, plus a state-carry code review; chain stays HELD until resolved; chain still HELD](bstar-regate-2026-09-16.md)**
- **[B-STAR PROD PROFILE 09-16: column solve 56 %, bvals 21 %; PCR32 + bvals at PRODUCTION occupancy (2 blocks/GPU, 2 ranks, smoke p_prod2gpu): 380 ms/cycle -> ~28 h for 40 turnovers vs 42 h old; tol 1e-6 and once-per-cycle REJECTED](bstar-prod-cost-profile.md)**
- **[PCR TIMINGS 09-16: 1.2x target NOT met, best 1.73x (nseg32), 1.47x loosened](pcr-timing-result.md) — user decides; never in a chain**
- **[He MODE-3 FLUX COLLAPSE SOLVED 09-16: mode 3 never got rt_bottom_flux; fix COMMITTED 1c45e532 (rg-box-convection) + 1fdce2b0 incl. PCR path and bvals window a8c69bc9 (rg-box-pcr, wt_m3acc), both unpushed, Q1f Ftop/Fbot 0.998; B-star gates G3f/G3p pending, prod_m3 HELD](he-mode3-flux-collapse.md)**

- **[B-star PROD 2 'prod_w4' SUBMITTED 09-15 ~10:50 as 11712113 -> 11712114 -> 11712115 (binary a1ef8822 = 3596f5b3; 4x wider, open top, ADI lod2 everywhere, skip_sweep, rescheck; ~15.5 h projected); He PROD 'box_w4' SUBMITTED as 11712116 -> 11712117 -> 11712118 (~41 h, 2-3 links; bottom inflow to be added at a link break); one-time startup checks armed](bstar-prod-w4-plan.md)**
- **[HANDOVER 2026-09-15 written (docs/handover, main tree commit; the CANONICAL handover dir is bench/wt_pap on polar-average-perf where 09-14 lives, copy untracked there); NEEDS A FINAL ADDENDUM for the He death/sponge/open top/ADI lod2/plaid cure/B-star restart](handover-2026-09-15-status.md)**
...
- **[STANDING: PORT EVERY RT/CONDUCTION FIX TO rg + dhj + ck RT (T-form, u-form, rt_use_cons, ALI diagonal PORTED to 8fce25af; mode 3 + outputs still to port; u-form WORSE on the red giant, keep off)](port-rt-fixes-to-rg-dhj.md)**
