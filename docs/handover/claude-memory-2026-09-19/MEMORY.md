## RULE ZERO
- **[He4 GLOBAL r11 SOLVED in 1-D (09-18): blow-up = top RT closure shuts when dense gas reaches it; RECIPE cfl 0.15 + rt_top_vacuum=true + Strang ON -> L_out 1.00-1.01, KEr saturates, dt 5 s at 2 turnovers; rt_strang=false diverges with dt (never); next 3-D with the recipe](he4-r11-floor-arms-verdict.md)**
