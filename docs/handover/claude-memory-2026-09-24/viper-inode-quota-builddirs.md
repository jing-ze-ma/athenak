...
- KOKKOS TRAP (09-23): athenak/kokkos (and every worktree's kokkos) is a SYMLINK to
  bench/wt_rgbox/kokkos. Removing worktree wt_rgbox on 09-23 broke all builds; restored from
  /viper/u2/.snapshots/daily-20260923063002 (Kokkos 4.6.2, d8e9af031). Never delete
  bench/wt_rgbox/kokkos (README_KEEP_KOKKOS.txt there). Check `readlink kokkos` before removing any worktree.
