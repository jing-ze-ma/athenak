...
**CURRENT STATE, 2026-09-16 ~01:45, VIPER.** B star prod_w4_p link 1 (11717690) running since 21:19, ~25 turnovers, f-mode growth is O(dt) NUMERICAL (fmode-dt-taper-test), no fix yet (force/heating centering null; Strang+ImEx broken, being debugged; per-stage opacity + rk1/rk3 arms in flight). He box_w4_in link 1 (11717692) since 22:26 with inflow+top sponge (M/M0 0.99, dt 0.095); links 2-3 = 11721321-2 carry the BOTTOM SPONGE (he-bottom-sponge). Science page v7. rt-integration pushed c4690cc8 (+e91b12a1 sponge unpushed); rt-imex pushed. PREVIOUS STATE (09-15 20:00): Both wide-box productions were CUT (user) and RESUBMITTED with a new binary (rg-box-pcr 974a6ad8, md5 4e5007b9: adds problem/rt_profile_dt, a horizontally averaged x1 profile dump, reader vis/python/read_rt_profile.py, format in the pgen header comment): B star bench/bstar_fecz/prod_w4_p (jobs 11717690-1, restart from prod_w4/rst/00019 = 19.0 turnovers, rt_profile_dt 100 s) and He bench/hestar_fecz/box_w4_in (11717692-4, restart from box_w4/rst/00009 = 9.0 turnovers, WITH bc_mode_bot 5 inflow controller tau_in 1128 s + top sponge vdamp_top_tau 0.1 + rt_profile_dt 10 s; smoke: M/M0 rising at the controller rate, floors/FOFC 20x down). Both PENDING, slurm estimate 08:11 09-16. Old chains 11712113-8 cancelled at 19.0 / 9.06 turnovers. Science page v6 (mean-v_z Hovmoller added; source bench/analysis_0915/bstar_page + vz_hov/): https://claude.ai/artifact/HQ5bHyDW67yShdAygahjBS. f-mode dt test: F03 done, F015 running (bench/bstar_fecz/plaid). MERGE in progress (user go): branch rt-integration in bench/wt_merge from rg-box-pcr, lhlld + implicit-transverse-raddiff merged, polar-average-perf next; unclear conflicts go to the USER. rg-box-pcr pushed to fork (235b05f0; 974a6ad8 not yet).
...
- **[USE rt-integration FOR EVERYTHING from 09-15 evening (user); old branches frozen](use-rt-integration-branch.md)**
