...
- **[f-MODE GROWTH IS O(dt) NUMERICAL (ratio 0.49); hand-over band (eos taper) suspected; taper scan jobs 11718115-8 submitted 09-15 20:35, read with fmode_dt.py](fmode-dt-taper-test.md)**
