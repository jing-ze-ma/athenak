...
NOT bitwise after the fix (red giant 200 cycles: KE_r 0.6 %, momenta 4 %). PORTED 0aa55a62 (only the hpp; plane-parallel 5f2be7d2 + box pgen still unported). TODO: re-check the red-giant photosphere/corona structure (the deposit sat at its tau 10-100) and the dhj RT.
