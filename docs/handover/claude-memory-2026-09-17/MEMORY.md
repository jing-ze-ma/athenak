...
- **[He w8 GROWS BUT SLOWLY (+0.42/turnover, 200x below w4); kmin/kmax are PER COMPONENT so 4..6 = |k| 5.7-8.5; box_w9 relaunched 09-17 with vpert 1e-2, k 3..4](he-w8-onset-slow.md)**
- **[B STAR prod_w7 at 10 turnovers = END OF LINEAR PHASE: one tilted L/4 stripe mode, KE1 +1.2/turnover through 8, saturated 9-10; redo maps at ~15](bstar-w7-linear-saturation.md)**
...
**CURRENT STATE, 2026-09-17 03:00, VIPER (user asleep).** B star bench/bstar_fecz/prod_w7 at 10.4 turnovers: END OF LINEAR PHASE (KE1 +1.2/turnover through 8, +0.03 at 10; one tilted L/4 stripe mode, maps analysis_0916/w7_dump10); oscillatory (2,2) f-mode flat +0.006/turnover (fmode_w7_t10) -> cache fix holds. He: box_w8 grows but slowly (200x below w4; kmin/kmax are per component); box_w9 LAUNCHED 02:30 (vpert 1e-2 c_s, k 3..4 per component, 21 jobs 11744300-320), w8 kept running -> USER DECIDES which to keep. VIPER MAINTENANCE 09-17 10:00-18:00: all 24-h chains start after 17:56; only 3-h backfill links run. CODE: rt-integration (bench/wt_merge) +7f9f68a7 wb_cache_every=0 in rg/dhj inputs; still UNPUSHED (f523f4d4, 67dd65cd, 7f9f68a7). PAGES: live v7 https://claude.ai/artifact/SLgYFj9JDBUsNqxj5UYgPJ (multi-file source athenak/.pages_w7, cheap to republish); old v6 83MWhbPZsHbZpdzRo15dtZ superseded (2.8 MB single file, never read it); science v12 HQ5bHyDW67yShdAygahjBS. Handover docs/handover/HANDOVER-2026-09-17.md.

**NEXT STEPS (09-17):** (1) B star maps/cuts/iso3d at ~15 turnovers (dump 15, commands in w7_dump10/NOTES.txt) -> expect breakup of the stripe mode; then light curve. (2) He: onset check on box_w9 dumps 1-2 (onset_he_w8.py with path -> box_w9); decide w8 vs w9, prune the loser. (3) Movie from cbin frames. (4) Push rt-integration after user OK. (5) Prune prod_w7/rst (0.9 GB each).
