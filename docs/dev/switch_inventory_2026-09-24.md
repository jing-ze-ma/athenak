...
| vet_bc_bath | true since m1-h2div (false on restarts whose file lacks the key) | vet_sc formal solution: rays entering at a marshak x1 end carry the incident bath implicit_ebath (not E + 3 F.Omega/c of the end cell) | runs_5j_h2div | bitwise for flux/reflect/periodic ends and gates.py; He slab/box NC 0 | shadow t=20: E_max 1.6 (be) / 6.6e12 (hesdirk2) -> 0.504, L1 0.234 -> 0.055; Marshak n=128 5.0 -> 4.1 % | DEFAULT-ON (tests_m1/runs_5j_h2div/README.md) |
